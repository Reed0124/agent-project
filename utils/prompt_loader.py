...
def load_system_prompts():
    try:
        ...
        logger.error(f"[load_system_prompts] 配置文件 prompts.yal 中缺少 main_prompt_path")
        raise e
...
def load_rag_prompts():
    try:
        ...
        logger.error(f"[load_rag_prompts] 配置文件 prompts.yal 中缺少 rag_prompt_path")
        raise e
...
def load_report_prompts():
    try:
        ...
        logger.error(f"[load_report_prompts] 配置文件 prompts.yal 中缺少 report_prompt_path")
        raise e
